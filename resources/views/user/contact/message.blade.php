...
<div class="container-fluid">
    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="contact-form bg-white p-30">
                 @if(session('messageSuccess'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <i class="fa-solid fa-check me-2"></i>{{ session('messageSuccess') }}
                ...
                @endif
                <div id="success"></div>
                <form name="sentMessage" id="contactForm" novalidate="novalidate" action="{{ route('user#contactCreat') }}" method="POST">
                    @csrf
                    ...
                    <div class="control-group mb-3">
                        <textarea class="form-control" rows="8" id="message" placeholder="Message" name="message" required="required" data-validation-required-message="Please enter your message"></textarea>
                        @error('message')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
