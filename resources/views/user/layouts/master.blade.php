        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block mt-2 ">
                <a href="#" class="text-decoration-none ">
                    <span class="h1 text-uppercase text-warning px-2">My Shop</span>
                </a>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('user#contactCreatePage') }}" class="nav-item nav-link">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="" class="btn px-0 ml-3 text-uppercase text-white">
                                <div class="dropdown d-inline">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item my-3" href="{{ route('user#accountChangePage') }}">
                                                <i class="fa-solid fa-user me-1 py-2"></i>Account
                                            </a>
                                        </li>
                                        <li><a class="dropdown-item my-3" href="{{ route('user#changePasswordPage') }}">
                                                <i class="fa-solid fa-key me-1 py-2"></i>Change Password
                                            </a>
                                        </li>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="">
                            <div class="input-group">
                                <input type="text" class="form-control rounded me-1" placeholder="Your Email Address">
