                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-md-center">Change Password</h3>
                                        </div>
                                        ...
                                        <form action="{{ route('user#changePassword') }}" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="confirmPassword" type="password" class="form-control @error('confirmPassword') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Password Confirmation">
