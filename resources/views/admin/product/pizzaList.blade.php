                ...
                <div class="table-responsive table-responsive-data2 mt-3">
                    ...
                    <table class="table table-data2 text-center">
                        ...
                        <tbody>
                            ...
                            <tr class="tr-shadow">
                                <td class="col-2">
                                    <img src="{{ asset('storage/'.$pizza->image )}}" alt="" class="rounded shadow-sm" style="height: 65px; width:60px;">
                                </td>
                                ...
                                <td class="col-2">
                                    <div class="table-data-feature">
                                        <a href="{{ route('product#edit',$pizza->id) }}">
                                            <button class="item mr-1" data-toggle="tooltip" data-placement="top" title="View">
